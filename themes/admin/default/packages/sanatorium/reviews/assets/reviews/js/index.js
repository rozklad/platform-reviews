...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'review');

		$('.daterangepicker_end_input').attr('data-grid', 'review');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('review', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
