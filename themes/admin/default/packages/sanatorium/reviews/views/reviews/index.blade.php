...
{{ Asset::queue('index', 'sanatorium/reviews::reviews/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<span class="navbar-brand">{{{ trans('sanatorium/reviews::reviews/common.title') }}}</span>
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.sanatorium.reviews.reviews.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="review" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="review" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="review" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
							...
							<span class="input-group-btn">
								...
								<button class="btn btn-default" data-grid="review" data-reset>
	...
	<div class="panel-body">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
			...
			<div id="data-grid_applied" class="btn-group" data-grid="review"></div>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.sanatorium.reviews.reviews.grid') }}" data-grid="review">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
					<th class="sortable" data-sort="id">{{{ trans('sanatorium/reviews::reviews/model.general.id') }}}</th>
					<th class="sortable" data-sort="user_id">{{{ trans('sanatorium/reviews::reviews/model.general.user_id') }}}</th>
					<th class="sortable" data-sort="reviewable_type">{{{ trans('sanatorium/reviews::reviews/model.general.reviewable_type') }}}</th>
					<th class="sortable" data-sort="reviewable_id">{{{ trans('sanatorium/reviews::reviews/model.general.reviewable_id') }}}</th>
					<th class="sortable" data-sort="percent">{{{ trans('sanatorium/reviews::reviews/model.general.percent') }}}</th>
					<th class="sortable" data-sort="text">{{{ trans('sanatorium/reviews::reviews/model.general.text') }}}</th>
					<th class="sortable" data-sort="created_at">{{{ trans('sanatorium/reviews::reviews/model.general.created_at') }}}</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
	...
	<footer class="panel-footer clearfix">
		...
		{{-- Grid: Pagination --}}
		<div id="data-grid_pagination" data-grid="review"></div>

	</footer>

	{{-- Grid: templates --}}
	@include('sanatorium/reviews::reviews/grid/index/results')
	@include('sanatorium/reviews::reviews/grid/index/pagination')
	@include('sanatorium/reviews::reviews/grid/index/filters')
	@include('sanatorium/reviews::reviews/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('sanatorium/reviews::reviews/help')
@endif
